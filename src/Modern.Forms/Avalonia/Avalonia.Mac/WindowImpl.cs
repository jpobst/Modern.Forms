...
namespace Avalonia.Native
{
    internal class WindowImpl : WindowBaseImpl, IWindowImpl//, ITopLevelImplWithNativeMenuExporter
    {
        ...
        internal WindowImpl(IAvaloniaNativeFactory factory, AvaloniaNativePlatformOptions opts) : base(opts)
        {
            _factory = factory;
            _opts = opts;
        ...
        {
            _native.SetDecorations(enabled ? SystemDecorations.SystemDecorationsFull : SystemDecorations.SystemDecorationsNone);
        }
